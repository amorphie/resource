...
public static class ResourceLanguageModule
{
    ...
    //     )
    // {
    //     var existingRecord = context?.Translations?.FirstOrDefault(t => t.Id == data.id);
    ...
    //  [FromServices] ResourceDBContext context)
    // {
    //     var existingRecord = context?.Translations?.FirstOrDefault(t => t.Id == resourceLanguageId);
    ...
    // // )
    // // {
    // //     var resource = context!.Translations!
    // //         .FirstOrDefault(t => t.Id == resourceLanguageId);

    // //     if (resource == null)
    // //         return Results.NotFound();

    // //     var resourceLanguage = context!.Translations!
    // //     .FirstOrDefault(t => t.Id == resourceLanguageId);
